...
export default function Sidebar({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  ...
  return (
    <>
      ...
      {/* Sidebar container */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-[#0d0d14] border-r border-white/5 flex flex-col transition-transform duration-300 md:static md:translate-x-0
      ...
      >
        ...
        <div className="px-6 py-5 border-b border-white/5 flex items-center justify-between">
          ...
          <button
            onClick={onClose}
            className="p-1 -mr-2 text-slate-500 hover:text-white md:hidden focus:outline-none"
